...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_saichran>
...
https://saicharanb.github.io/521-Lab4/
...
This code chunk option (message=FALSE) hides the message from being displayed in the output. In its absence, the text 'This is a message' would be displayed in the output cell.
...
The two code chunks here sets the height and width of the figure being plotted. fig.height sets the height of the plot to 5, and fig.width sets the width of the plot to 5.

```{r fig.height=5, fig.width=5}


example_plot <-  c(5,6,7,8,9,10)
plot(example_plot)
```
...
1. https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_saichran/blob/master/q7.html

2. https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_saichran/blob/master/q7.pdf
...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_saichran/blob/master/q8.Rmd

https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_saichran/blob/master/q8.html
...
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_saichran/blob/master/q9.md

It is rendered like a markdown file. It resembles most ReadMe files.
...
https://saicharanb.github.io/521-Lab4/q10#/title-slide
...
Advantages of Powerpoint, Word, Keynote, etc : They are more accessible to more people as they do not require technical experience and are easier to use. It is UI based.

Advantages of R Markdown and Jupyter : They offer more options for customization and we can control every aspect of the presentation and report. We get more options and more functionality.
